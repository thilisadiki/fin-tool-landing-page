...
export default function SarsIncomeTaxCalculator() {
  ...
  return (
    <>
      <Helmet>
        <title>Free SARS Income Tax Calculator {CURRENT_TAX_YEAR.year} | Quick Money Tool</title>
        <meta
          name="description"
          content={`Free SARS income tax calculator for South Africa (${CURRENT_TAX_YEAR.year}). Calculate your PAYE, tax rebates, medical credits, and take-home pay instantly.`}
        />
        <meta
          name="keywords"
        ...
        <meta property="og:description" content="Calculate your South African income tax, rebates, and net pay for free." />
        <meta property="og:url" content="https://www.quickmoneytool.com/calculators/sars-income-tax-calculator" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json">{JSON.stringify(taxCalcSchema)}</script>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  For the {CURRENT_TAX_YEAR.year} tax year, rates range from 18% on the first R237,100 up to 45%
                  on income above R1,817,000.
                </p>
