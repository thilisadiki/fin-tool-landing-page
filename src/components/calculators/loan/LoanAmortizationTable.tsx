...
export default function LoanAmortizationTable({ result }: LoanAmortizationTableProps) {
        ...
        <AccordionContent>
          ...
          <div className="mt-6 flex flex-col space-y-3 text-sm p-4 rounded-xl border border-border/50 bg-accent/20">
             <div className="flex justify-between border-b border-border/50 pb-2">
                ...
                <span className="font-medium text-foreground">{formatZAR(result.totalFeesPaid)}</span>
             </div>
             <div className="flex justify-between border-b border-border/50 pb-2">
             ...
             <div className="flex justify-between font-bold pt-1">
                <span className="text-foreground">Total Repayment Amount</span>
